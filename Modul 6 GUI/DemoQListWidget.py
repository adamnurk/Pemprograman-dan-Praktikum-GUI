...
class MainForm(QWidget):
    def __init__(self):
        super().__init__()
        self.setupUi()
    # Function membuat tampilan GUI nya
    def setupUi(self):
        self.resize(400, 300)
        self.move(300, 300)
        ...
        self.addItemButton.clicked.connect(self.addItemButtonClick) # Untuk connect ke function addItemButton
        self.moveRightButton.clicked.connect(self.moveRightButtonClick) # Untuk connect ke function moveRightButton
        self.moveRightAllButton.clicked.connect(self.moveRightAllButtonClick) # Untuk connect ke function moveRightAllButton
        self.moveLeftButton.clicked.connect(self.moveLeftButtonClick) # Untuk connect ke function moveLeftButton
        self.moveLeftAllButton.clicked.connect(self.moveLeftAllButtonClick) # Untuk connect ke function moveLeftAllButton
